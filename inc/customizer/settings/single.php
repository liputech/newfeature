 ...
 */
class NewfeatureTheme_Blog_Single_Post_Settings extends NewfeatureTheme_Customizer {
    ...
    public function register_blog_single_post_controls( $wp_customize ) {
        ...
        $wp_customize->add_control( new Customizer_Image_Radio_Control( $wp_customize, 'post_style',
            array(
                'label' => __( 'Single Post Layout', 'newfeature' ),
                'description' => esc_html__( 'Post single layout variation you can selecr and use.', 'newfeature' ),
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_featured_image',
            array(
                'label' => __( 'Show Featured Image', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_author_name',
            array(
                'label' => __( 'Show Author Name', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_date',
            array(
                'label' => __( 'Show Post Date', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_comment_num',
            array(
                'label' => __( 'Show Comment Number', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_share',
            array(
                'label' => __( 'Show Share', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_links',
            array(
                'label' => __( 'Show Next / Previous post', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_author_bio',
            array(
                'label' => __( 'Show Author Bio', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'post_length',
            array(
                'label' => __( 'Post Reading Length', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control(new Customizer_Heading_Control($wp_customize, 'post_related', array(
            'label' => __( 'Related Post Settings', 'newfeature' ),
            'section' => 'single_post_secttings_section',
        )));
        ...
        $wp_customize->add_control( new Customizer_Switch_Control( $wp_customize, 'show_related_post',
            array(
                'label' => __( 'Show Related Post', 'newfeature' ),
                'section' => 'single_post_secttings_section',
            )
        ));
        ...
        $wp_customize->add_control( 'show_related_post_number',
            array(
                'label' => __( 'Show Related Post Number', 'newfeature' ),
                'section' => 'single_post_secttings_section',
                'type' => 'number',
            )
        );
        ...
        $wp_customize->add_control( 'show_related_post_title_limit',
            array(
                'label' => __( 'Show Related Post Title Length', 'newfeature' ),
                'section' => 'single_post_secttings_section',
                'type' => 'number',
            )
        );
        ...
        $wp_customize->add_control( 'related_post_query',
            array(
                'label' => __( 'Query Type', 'newfeature' ),
                'section' => 'single_post_secttings_section',
                'description' => esc_html__( 'Post Query', 'newfeature' ),
                'type' => 'select',
                'choices' => array(
                    'cat' => esc_html__( 'Posts in the same Categories', 'newfeature' ),
                    'tag' => esc_html__( 'Posts in the same Tags', 'newfeature' ),
                    'author' => esc_html__( 'Posts by the same Author', 'newfeature' ),
                ),
            )
        );
        ...
        $wp_customize->add_control( 'related_post_sort',
            array(
                'label' => __( 'Sort Order', 'newfeature' ),
                'section' => 'single_post_secttings_section',
                'description' => esc_html__( 'Display post Order', 'newfeature' ),
                'type' => 'select',
                'choices' => array(
                    'recent' => esc_html__( 'Recent Posts', 'newfeature' ),
                    'rand' => esc_html__( 'Random Posts', 'newfeature' ),
                    'modified' => esc_html__( 'Last Modified Posts', 'newfeature' ),
                    'popular' => esc_html__( 'Most Commented posts', 'newfeature' ),
                    'views' => esc_html__( 'Most Viewed posts', 'newfeature' ),
                ),
            )
        );
...
if ( class_exists( 'WP_Customize_Control' ) ) {
	new NewfeatureTheme_Blog_Single_Post_Settings();
}
