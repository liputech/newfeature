...
if ( ! function_exists( 'rttheme_generate_defaults' ) ) {
    function rttheme_generate_defaults() {
        $customizer_defaults = array(
			...
			'header_opt'       			=> 1,
            'header_style'      		=> 1,
            'header_location'      		=> 'Our Address',
            'header_hotline_txt'      	=> 'Call for help',
            'header_mailus_txt'      	=> 'Mail to us',
            'header_open_txt'      		=> 'Sunday - Friday',			
            'search_icon'      			=> 0,
			...
			// Footer
            'footer_style'        		=> 1,
            'copyright_text'      		=> '&copy; ' . date('Y') . ' newfeature. All Rights Reserved by <a target="_blank" rel="nofollow" href="' . NEWFEATURE_AUTHOR_URI . '">RadiusTheme</a>',
			'footer_column_1'			=> 4,
            'footer_column_2'           => 4,
            'footer_column_3'           => 4,
			'footer_area'				=> 1,
			...
			'wc_block_layouts' => 'newfeaturestyle4',
