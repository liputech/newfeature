...
.case-multi-layout-2 .rtin-item .item-overlay {
    background-color: rgba(<?php echo esc_html( $secondary_rgb );?>, 0.6);
}
...
.widget_newfeature_download .download-list .item-icon i,
.widget_newfeature_about_author .author-widget .about-social li a {
    color: <?php echo esc_html($primary_color); ?>;
}
...
.widget_newfeature_about_author .author-widget .about-social li a:hover {
	background-color: <?php echo esc_html($secondary_color); ?>;
}
.widget_newfeature_about_author .author-widget:after {
    background: rgba(<?php echo esc_html( $primary_rgb );?>, 0.85);;
}
