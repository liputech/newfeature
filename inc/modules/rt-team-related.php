...
if( ! function_exists( 'newfeature_related_team' )){
	
	function newfeature_related_team(){
		$thumb_size = 'newfeature-size6';
		$post_id = get_the_id();	
		$number_of_avail_post = '';
		$current_post = array( $post_id );
		$title_length = NewfeatureTheme::$options['related_team_title_limit'] ? NewfeatureTheme::$options['related_team_title_limit'] : '';
		$related_post_number = NewfeatureTheme::$options['related_team_number'];
		...
		# Get related posts by categories ----------
			...
			$terms = get_the_terms( $post_id, 'newfeature_team_category' );
			...
			$args['tax_query'] = array (
				array (
					'taxonomy' => 'newfeature_team_category',
					'field'    => 'ID',
		...
		<div class="team-default team-multi-layout-1 team-grid-style1 owl-wrap rt-woo-nav rt-related-post">
			...
			<?php if ( NewfeatureTheme::$options['team_related_title'] ) { ?>
			<h3 class="related-title"><?php echo wp_kses( NewfeatureTheme::$options['team_related_title'] , 'alltext_allow' );?></h3><?php } ?>
				<?php if ( $count_post > 3 ){ ?>
			...
			<div class="owl-theme owl-carousel rt-owl-carousel" data-carousel-options="<?php echo esc_attr( $owl_data );?>">
				<?php
					...
					$id = get_the_ID();
					$socials       	= get_post_meta( $id, 'newfeature_team_socials', true );
					$social_fields 	= NewfeatureTheme_Helper::team_socials();
					$position   	= get_post_meta( $id, 'newfeature_team_position', true );
				?>
					<div class="rtin-item">						
						<div class="rtin-content-wrap">		
							<div class="rtin-thums">
								...
								<?php if ( NewfeatureTheme::$options['related_team_social'] ) { ?>
							...
							<div class="mask-wrap">
								<div class="rtin-content">									
									<?php if ( NewfeatureTheme::$options['related_team_position'] ) { ?>
