...
$subtitle = get_post_meta( get_the_ID(), 'newfeature_subtitle', true );
						...
						<div class="media about-author">
							...
							<div class="media-body">
								<div class="about-author-info">
									...
									<div class="author-designation"><?php if ( !empty ( $newfeature_author_designation ) ) {	echo esc_html( $newfeature_author_designation ); } else {	$user_info = get_userdata( $author ); echo esc_html ( implode( ', ', $user_info->roles ) );	} ?></div>
								</div>
